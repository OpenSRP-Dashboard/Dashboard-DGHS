...
angular.module('opensrpSiteApp')
  .service('Common', function ($q,$rootScope, $http,filterFilter,AclService,OPENSRP_WEB_BASE_URL) {
    ...
    this.userRoleCondition = function($scope,$cookies){
      $scope.userCondition = "";
  ...
  this.createUserCondition = function($scope,$cookies){
    if($cookies.get('roleName') =="Admin"){ 
      ...
      getUnionListByThanaId($scope,$cookies.get('locationId'));
      $scope.unionShowHide = true;
      $scope.wardShowHide = true;
      $scope.unitShowHide = true;
      $scope.HAShowHide = true;
      ...
      $scope.HAShowHide = true;
      $scope.nameShowHide = true;       
      getWordListByUnionId($scope,$cookies.get('locationId'));
    }else if($cookies.get('roleName') =="HA"){
          $scope.nameShowHide = true;
    }else{
  ...
  function  getUnionListByThanaId($scope,thanaId){
  ...
  function  getWordListByUnionId($scope,unionId){
